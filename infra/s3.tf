# Site bucket — holds Astro build output. Private, accessed only by CloudFront via OAC (added in Task 5).
...
# Media bucket — holds admin-uploaded videos. Same lockdown.
